...
#: **المفسِّرُ هو الذي يُشغَّل الآن، لا بيئةٌ مسمّاةٌ باسمها.**
#:
#: كان `ROOT/".venv-taaqol"/…` مكتوبًا، فالسمُّ لا يُشغَّل إلا لمن بيئتُه
#: بذلك الاسم — ويسقط `FileNotFoundError` على كلّ بيئةٍ سواها. ومالكُ
#: القاعدة لا يملك تشغيلَ سمِّها حينئذٍ. وهو `B11` في موضعٍ رابع.
