...
```json
{
 ...
 "total_events_affected": 18143,
 "total_events_denominator": "مواضعُ حرفٍ يُرفع عندها صنف — لا كلماتٍ متمايزة",
 "total_words_affected": 18135,
 "total_words_denominator": "كلماتٌ تحمل صنفًا — عمود Owner_Decision_Classes",
 "difference_accounted_in": "output/bound/02_class_count.json",
